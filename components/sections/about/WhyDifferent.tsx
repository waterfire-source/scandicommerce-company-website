const features = [
  {
    ...
    description:
      "No proposal ping-pong. Browse packages with clear pricing like you'd shop for products.",
  },
  {
    icon: (
      <svg
    ...
    description:
      'Productized packages you can browse, compare, and select without endless meetings.',
  },
  {
    icon: (
      <svg
    ...
    title: 'Results First',
    description:
      'We measure success in conversions, revenue, and growth—not just deliverables.',
  },
]
