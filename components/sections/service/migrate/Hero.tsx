      ...
      <div className="container flex flex-col justify-center items-center mx-auto px-4 sm:px-6 lg:px-8 relative z-10 gap-[42px]">
        <div className="flex flex-col justify-start items-center gap-[53px] sm:w-3/4 2xl:w-1/2 w-full">
          <h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-center mb-4 sm:mb-6">
            <span className="xl:text-[#FFFFFF] text-[#222222]">Migrate to</span>{' '}
            <span className="text-[#1DEFFA]">Shopify without</span>{' '}
            <span className="xl:text-[#FFFFFF] text-[#222222]">the risk</span>
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full">
          <Link
            href="/contact"
            className="bg-[#1DEFFA] text-[#1F1D1D] px-8 py-4 hover:bg-[#1DEFFA]/90 transition-colors text-center w-full sm:w-auto"
          >
            Get Migration Quote
          </Link>
          <Link
